	...
	public function get_fields_display( $form_field, $local_field, $post_id = false, $wg_id = false ){
		switch( $form_field[ 'field_type' ] ){
			...
			case 'taxonomy':
				...
				$local_field[ 'field_type' ] = isset( $form_field[ 'field_taxonomy_appearance' ] ) ? $form_field[ 'field_taxonomy_appearance' ] : 'checkboxes';
				$local_field[ 'allow_null' ] = 0;
				$local_field[ 'add_term' ] = isset( $form_field[ 'field_add_term' ] ) ? $form_field[ 'field_add_term' ] : 0;
			...
			case 'product_tags':
				...
				$local_field[ 'field_type' ] = isset( $form_field[ 'field_taxonomy_appearance' ] ) ? $form_field[ 'field_taxonomy_appearance' ] : 'checkbox';
				$local_field[ 'allow_null' ] = 0;
				$local_field[ 'add_term' ] = isset( $form_field[ 'field_add_term' ] ) ? $form_field[ 'field_add_term' ] : 0;
				$local_field[ 'load_terms' ] = 1;
				$local_field[ 'save_terms' ] = 1;
