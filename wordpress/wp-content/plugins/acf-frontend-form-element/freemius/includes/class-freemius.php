...
------------------------------------------------------------------------------------------------------------------*/
        ...
        function _get_uninstall_reasons( $user_type = 'long-term' ) {
            ...
            $reason_found_better_plugin = array(
                ...
                'input_placeholder' => sprintf( $this->get_text_inline( "What's the %s's name?", 'placeholder-acf-frontend-form-elements' ), $module_type ),
            );
        ...
        private static function _load_required_static() {
            ...
            self::$_accounts = FS_Options::instance( WP_FS__ACCOUNTS_acfef, true );
        ...
        private static function migrate_options_to_network() {
            ...
            $api_network_options = FS_Option_Manager::get_manager( WP_FS__OPTIONS_acfef, true, true );
            $api_network_options->migrate_to_network();

            // Migrate API cache to network level storage.
            FS_Cache_Manager::get_manager( WP_FS__API_CACHE_acfef )->migrate_to_network();
...
//			$this->sync_install( array(), true );
        ...
        private function get_plugins_data_for_api() {
            // Alias.
            $site_active_plugins_acfef = 'active_plugins';
            $network_plugins_acfef     = 'all_plugins';

            /**
             * Collection of all site level active plugins.
             */
            $site_active_plugins_cache = self::$_accounts->get_option( $site_active_plugins_acfef );
            ...
            self::$_accounts->set_option( $site_active_plugins_acfef, $site_active_plugins_cache, true );
             ...
             */
            $network_plugins_cache = self::$_accounts->get_option( $network_plugins_acfef );
            ...
            self::$_accounts->set_option( $network_plugins_acfef, $network_plugins_cache, true );
