<?php
    ...
    class FS_GDPR_Manager {
        ...
        private function __construct() {
            $this->_storage     = FS_Option_Manager::get_manager( WP_FS__GDPR_acfef, true, true );
            $this->_wp_user_id  = Freemius::get_current_wp_user_id();
            $this->_acfef = "u{$this->_wp_user_id}";
            $this->_data        = $this->_storage->get_option( $this->_acfef, array() );
        ...
        private function update_option( $name, $value ) {
            ...
            $this->_storage->set_option( $this->_acfef, $this->_data, true );
        }
