...
//		define( 'WP_FS__LOCALHOST_IP', WP_FS__VVV_DEFAULT_PUBLIC_IP );
    ...
    if ( ! defined( 'WP_FS__ACCOUNTS_acfef' ) ) {
        define( 'WP_FS__ACCOUNTS_acfef', WP_FS___OPTION_PREFIX . 'accounts' );
    }
    if ( ! defined( 'WP_FS__API_CACHE_acfef' ) ) {
        define( 'WP_FS__API_CACHE_acfef', WP_FS___OPTION_PREFIX . 'api_cache' );
    }
    if ( ! defined( 'WP_FS__GDPR_acfef' ) ) {
        define( 'WP_FS__GDPR_acfef', WP_FS___OPTION_PREFIX . 'gdpr' );
    }
    define( 'WP_FS__OPTIONS_acfef', WP_FS___OPTION_PREFIX . 'options' );
